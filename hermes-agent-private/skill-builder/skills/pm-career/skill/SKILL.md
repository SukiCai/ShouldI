...
Before any career diagnosis, confirm the user's country context — the PM market, salary benchmarks, immigration dynamics, and career ceiling all differ materially between the US and Canada.

1. **Which country?** US / Canada / Other
2. **If Canada — which province?** (BC, Ontario, Alberta, Quebec have different pay transparency laws, cost of living, and tech market depth)

**If US:** Apply FAANG-anchored salary benchmarks (levels.fyi), H-1B wage-level implications for comp negotiation, and the standard FAANG level equivalency table (Amazon L6 = Google L5 Senior PM). See Diagnostic Framework below.  
**If Canada:** Apply Canadian PM benchmarks (CAD $120K–$165K senior PM), PGWP open work permit leverage, LMIA/Global Talent Stream dynamics, and Canadian tech employer landscape (Shopify, RBC/TD digital, Vancouver FAANG offices). See Canada PM Market section.  
**If Other:** Acknowledge limitation and ask for clarification on local market before giving comp or level advice.
...
For users in Canada, apply these country-specific benchmarks and dynamics instead of US defaults.

**Market size and key employers:**
- Smaller total PM market than US (~10–15% of US volume), concentrated in Toronto, Vancouver, Ottawa, Montreal
- Key employers: Shopify (Ottawa + remote, largest CA-headquartered tech), Amazon Canada (Toronto/Vancouver), Google Canada (Waterloo), Microsoft Canada, RBC/TD/Scotiabank digital divisions, Wealthsimple, Faire, Lightspeed, Clio

**Official wage data (Government of Canada Job Bank, NOC 60010, 2023–2024):**
- National: Low $36.54/hr (~$76K CAD), Median $60.10/hr (~$125K CAD), High $112.00/hr (~$233K CAD)
- Ontario (Toronto): Low $38.00/hr, Median $60.10/hr, High $132.57/hr (~$276K CAD)
- British Columbia: Low $35.83/hr, Median $55.65/hr (~$116K CAD), High $89.25/hr (~$186K CAD)
- Alberta: Low $34.97/hr, Median $65.00/hr (~$135K CAD), High $99.29/hr
- Source: Labour Force Survey, Statistics Canada — [jobbank.gc.ca/marketreport/wages-occupation/26656/ca](https://www.jobbank.gc.ca/marketreport/wages-occupation/26656/ca)

**Salary benchmarks by level (CAD, 2025, including equity at tech employers):**
- Junior PM (0–3 yrs): $80K–$100K
- PM / Mid-Level (3–6 yrs): $100K–$130K
- Senior PM (6–10 yrs): $130K–$175K (RSUs at Shopify/FAANG Canada push toward top)
- Staff / Principal PM: $165K–$210K
- Director+ / GPM: $210K–$260K+

**PGWP and work authorization for PMs:**
- PGWP holders have an open work permit — no LMIA needed, full mobility between employers
- This gives PGWP holders the same negotiation leverage as Canadian citizens; do NOT treat them as employer-dependent
- LMIA (Labour Market Impact Assessment) required only for employer-specific permits; Global Talent Stream expedites LMIA to ~2 weeks for qualifying tech employers

**Career ceiling in Canada vs. US:**
- Top-of-market Canadian PM comp is materially below equivalent US FAANG roles (CAD $200K vs. USD $400K–$600K total comp at L7/L8 equivalent)
- "Stuck at Senior PM" in Canada may be an org ceiling problem OR a market-size problem — fewer Principal/Staff seats exist because fewer companies operate at that scale
- Canada → US path for Canadian citizens: TN visa under CUSMA (no lottery, renewable indefinitely) is viable after building Canadian PM experience

**Key diagnosis differences for Canada users:**
- Immigration security often outweighs comp premium for Indian/Chinese nationals (no H-1B lottery, Express Entry PR in ~1–2 years vs. 134-year EB-2 India backlog)
- Pay transparency laws (BC Nov 2023, Ontario Jan 2026 for 25+ employees) mean posted salary ranges are increasingly available — use them as floor anchors in negotiation
- For career-switchers: fewer APM programs in Canada; entry typically through adjacent roles (data analyst, UX researcher, business analyst)
