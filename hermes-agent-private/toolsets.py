...
_HERMES_CORE_TOOLS = [
    ...
    "session_search",
    # Clarifying questions + smart talk interview
    "clarify",
    "smart_talk_state",
...
TOOLSETS = {
    ...
    "smart_talk": {
        "description": "Socratic task specification interview — semantic ambiguity scoring across goal/constraints/criteria dimensions until ≤20% ambiguity",
        "tools": ["smart_talk_state"],
        "includes": []
    },
